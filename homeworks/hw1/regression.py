...
class regression:
    ...
    def compute_coefs(self):
        A = interpolation_polynomial.interpolation_polynomial.polynomial_terms(self.x_sample, self.num_terms)
        # Gram matrix
    ...
    def interpolate(self, x):
        terms = interpolation_polynomial.interpolation_polynomial.polynomial_terms(x, len(self.coefs))
